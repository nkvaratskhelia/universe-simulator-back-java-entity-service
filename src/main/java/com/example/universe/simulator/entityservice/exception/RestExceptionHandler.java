...
class RestExceptionHandler {
    ...
    private ResponseEntity<RestErrorResponse> buildErrorResponse(ErrorCodeType errorCode, String message) {
        RestErrorResponse response = new RestErrorResponse(errorCode, message);
    ...
    private ResponseEntity<RestErrorResponse> handleAppException(AppException exception) {
        log.error("", exception);
        return buildErrorResponse(exception.getErrorCode(), exception.getMessage());
    }
    ...
    private ResponseEntity<RestErrorResponse> handleEmptyResultDataAccessException(EmptyResultDataAccessException exception) {
        log.error("", exception);
        return buildErrorResponse(ErrorCodeType.NOT_FOUND_ENTITY, exception.getMessage());
    }
    ...
    private ResponseEntity<RestErrorResponse> handleHttpMediaTypeNotSupportedException(HttpMediaTypeNotSupportedException exception) {
        log.error("", exception);
        return buildErrorResponse(ErrorCodeType.INVALID_CONTENT_TYPE, exception.getMessage());
    }
    ...
    private ResponseEntity<RestErrorResponse> handleHttpMessageNotReadableException(HttpMessageNotReadableException exception) {
        log.error("", exception);
        return buildErrorResponse(ErrorCodeType.INVALID_REQUEST_BODY, exception.getMessage());
    }
    ...
    private ResponseEntity<RestErrorResponse> handleHttpRequestMethodNotSupportedException(HttpRequestMethodNotSupportedException exception) {
        log.error("", exception);
        return buildErrorResponse(ErrorCodeType.INVALID_HTTP_METHOD, exception.getMessage());
    }
    ...
    private ResponseEntity<RestErrorResponse> handleMethodArgumentTypeMismatchException(MethodArgumentTypeMismatchException exception) {
        log.error("", exception);
        return buildErrorResponse(ErrorCodeType.INVALID_REQUEST_PARAMETER, exception.getMessage());
    }
    ...
    private ResponseEntity<RestErrorResponse> handleObjectOptimisticLockingFailureException(ObjectOptimisticLockingFailureException exception) {
        log.error("", exception);
        return buildErrorResponse(ErrorCodeType.ENTITY_MODIFIED, exception.getMessage());
    }
    ...
    private ResponseEntity<RestErrorResponse> handlePropertyReferenceException(PropertyReferenceException exception) {
        log.error("", exception);
        return buildErrorResponse(ErrorCodeType.INVALID_SORT_PARAMETER, exception.getMessage());
    }

    @ExceptionHandler(Exception.class)
    private ResponseEntity<RestErrorResponse> handleUnknownException(Exception exception) {
        log.error("", exception);
        return buildErrorResponse(ErrorCodeType.SERVER_ERROR, exception.getMessage());
    }
}
